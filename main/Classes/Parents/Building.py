...
class Building(ABSObject):
    def __init__(self, name: str, id: int, color: tuple, power_usage: int, power_output: int, water_usage: int, water_output: int, min_people: int, people_capacity: int, max_level: int, is_habitable: int):
